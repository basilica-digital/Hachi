...
def intt_l1(a):
    ...
    print("    for i in 0..4{")
    print("        for j in 0..2{")
    print("            [a1[i*4+j], a1[i*4+j+2]] = barrett_butterfly_"+str(a)+"(a0[i*4+j], a0[i*4+j+2], l3[2*i], l3[2*i+1]);")
    print("        }")
    print("    }")
    print("    // inverse Layer 2")
    print("    for i in 0..4{")
    print("        [a0[i], a0[i+4]] = barrett_butterfly_"+str(a)+"(a1[i], a1[i+4], l2[0], l2[1]);")
    print("        [a0[i+8], a0[i+12]] = barrett_butterfly_"+str(a)+"(a1[i+8], a1[i+12], l2[2], l2[3]);")
    print("    }")
    print("    // inverse Layer 1")
    print("    for i in 0..8{")
    print("        [a1[i], a1[i+8]] = barrett_butterfly_"+str(a)+"(a0[i], a0[i+8], l1[0], l1[1]);")
    print("    }")
    print("    a1")
    print("}\n")
...
def intt_l2(a):
    ...
    print("    for i in 0..4{")
    print("        for j in 0..2{")
    print("            [a1[i*4+j], a1[i*4+j+2]] = barrett_butterfly_"+str(a)+"(a0[i*4+j], a0[i*4+j+2], l7[2*i], l7[2*i+1]);")
    print("        }")
    print("    }")
    print("    // inverse Layer 6")
    print("    for i in 0..4{")
    print("        [a0[i], a0[i+4]] = barrett_butterfly_"+str(a)+"(a1[i], a1[i+4], l6[0], l6[1]);")
    print("        [a0[i+8], a0[i+12]] = barrett_butterfly_"+str(a)+"(a1[i+8], a1[i+12], l6[2], l6[3]);")
    print("    }")
    print("    // inverse Layer 5")
    print("    for i in 0..8{")
    print("        [a1[i], a1[i+8]] = barrett_butterfly_"+str(a)+"(a0[i], a0[i+8], l5[0], l5[1]);")
    print("    }")
    print("    a1")
    print("}\n")
